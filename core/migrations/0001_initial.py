    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('solicitada', 'solicitada'), ('aprobada', 'aprobada'), ('rechazada', 'rechazada')], max_length=20)),
                ('tipo_solicitud', models.CharField(choices=[('primera', 'primera'), ('renovacion', 'renovacion')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contacto_emergencia', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='core.contactoemergencia')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado_credencial', models.CharField(choices=[('activa', 'Activa'), ('inactiva', 'Inactiva')], max_length=10)),
